    ...
    return (
      <div >
       ...
       <div className="horizontal-scroll-wrapper texts">
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞☞ﾟ∀ﾟ)☞(☞ﾟ∀ﾟ)☞"}/></div>
          ...
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"If you don't prioritize your life, someone else will."}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"Have you ever found yourself stretched too thin? Have you ever felt both overworked and underutilized? Do you ever feel busy but not productive? Like you're always in motion, but never getting anywhere?"}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"Once we accept the reality of trade-offs we stop asking, 'How can I make it all work?' and start asking the more honest question 'Which problem do I want to solve?'"}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"As poet Mary Oliver wrote:'Tell me, what is it you plan to do with your one wild and precious life?' I challenge you to pause more to ask yourself that question."}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"EACH NIGHT, WHEN I GO TO SLEEP, I DIE. AND THE NEXT MORNING, WHEN I WAKE UP, I AM REBORN. --Mahatma Gandhi"}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"What if society stopped telling us to buy more stuff and instead allowed us to create more space to breath and think? What if society encouraged us to reject what has been accurately described as doing things we detest, to buy things we don't need, with money we don't have, to impress people we don't like? What if we stopped being oversold the value of having more and being undersold the value of having less? What if we stopped celebrating being busy as a measurement of importance? What if instead we celebrated how much time we have spent listening, pondering, meditating, and enjoy time with the most important people in our lives?"}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"It's critical to set aside time to take a breath, look around, and think. You need that level of clarity in order to innovate and grow. When I say focus, I don't mean simply picking a question or possibility and thinking about it obsessively. I mean creating the space to explore one hundred questions and possibilities. An Essentialist focuses the way our eye focus; not by fixating on something but by constantly adjusting and adapting to the field of vision."}/></div>
          <div><CopyExample copyTextMethod={this.props.copyTextMethod} copy={"Setting aside some time to put a little 'Think Week' into every day. One practice I've found useful is simply to read something from classic literature. It broadens my perspective and reminds me of themes and ideas that are essential enough to have withstood the test of time. There are myriad of options. Just make sure you select something that was written before our hyperconnected era and yet seems timeless."}/></div>
      ...
      <br/>
      Copy the image address of your chosen one.
      ...
      <br/>
        <div className="horizontal-scroll-wrapper squares">
          ...
          <div><img src="./images/grace.png" alt="grace"/></div>
          <div><img src="./images/1.png" alt="1"/></div>
          ...
          <div><img src="./images/stretched.gif" alt="stretched"/></div>
          <div><img src="https://i-h1.pinimg.com/564x/12/3c/89/123c899c49333b96f0b052d3a82ee8b6.jpg" alt="lastone"/></div>
        </div>
        </div>
      </div>
    )
